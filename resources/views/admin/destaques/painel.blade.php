			    ...
			    <tbody>
			    	@foreach($destaques as $d)
				    	<tr>
							...
							<td>{{ $d->descricao }}</td>
							<td>{{ $d->link }}</td>
							<td><a class="btn btn-primary" href="{{ action('AtracoesController@exibir', $d->id) }}"><span class='glyphicon glyphicon-search'></span></a></td>
							<td><a class="btn btn-success" href="{{ action('AtracoesController@editar', $d->id) }}"><span class='glyphicon glyphicon-pencil'></span></a></td>
							<td><a class="btn btn-danger apagar" href="#" data-nome="destaques-{{ $d->textoDestaque }}" data-id="{{ $d->id}}"><span class='glyphicon glyphicon-remove'></span></a></td>
						</tr>
					@endforeach
			    </tbody>
			</table>
